...
int main() {
    ...
    while (true) {
        ...
        cout << (doubleEvenSum % 10 == 0 ? "The Card Number is VALID!" : "The card number is INVALID!") << endl;
        if (doubleEvenSum % 10 == 0 )
        {
            if(ccNumber[0]=='3')
            cout<<"The Card is of american express\n";
        else
            if(ccNumber[0]=='4')
            cout<<"The Card is of Visa\n";
        else
            if(ccNumber[0]=='5')
            cout<<"The Card is of Mastercard\n";
        else
            if(ccNumber[0]=='6')
            cout<<"The Card is of Discover\n";
        }
